...
function set_result( id )
    ...
    if result_sentence ~= nil and result_sentence ~= "" and not nonTTS then
        ...
        result_sentence, trash = string.gsub ( result_sentence, "!STREET!", escape_replacement_string(tts_street_1) )
        result_sentence, trash = string.gsub ( result_sentence, "!STREET_2!", escape_replacement_string(tts_street_2) )
        result_sentence, trash = string.gsub ( result_sentence, "!SIGNPOST!", escape_replacement_string(tts_signpost_1) )
        result_sentence, trash = string.gsub ( result_sentence, "!SIGNPOST_2!", escape_replacement_string(tts_signpost_2) )
        ...
        result_sentence, trash = string.gsub ( result_sentence, "!NG_COMMAND_1!", escape_replacement_string(natural_guidance_terms[1]) )
        result_sentence, trash = string.gsub ( result_sentence, "!NG_COMMAND_2!", escape_replacement_string(natural_guidance_terms[2]) )
        result_sentence, trash = string.gsub ( result_sentence, "!EXIT_NUMBER!", escape_replacement_string(tts_exit_number) )
        result_sentence, trash = string.gsub ( result_sentence, "!ROUTE_ATTRIBUTES!", escape_replacement_string(route_attributes_string) )
        ...
        if tts_output_format == "raw" then
            ...
            -- Fix for MSDKB-1575, deleting address tags for RAW option
            result_sentence, _ = string.gsub( result_sentence, "!NORMAL_MODE!", "" )
            result_sentence, _ = string.gsub( result_sentence, "!ADDRESS_MODE!", "" )
        else
            ...
            -- replacing address tags for Nuance
